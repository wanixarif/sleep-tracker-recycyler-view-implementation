...
//                adapter.submitList(it)
        ...
        sleepTrackerViewModel.navigateToContacts.observe(viewLifecycleOwner, Observer { isNav->
            if (isNav){
                this.findNavController().navigate(SleepTrackerFragmentDirections.actionSleepTrackerFragmentToContactsNav())
                sleepTrackerViewModel.onContactNavNavigatedDone()
            }
        })
